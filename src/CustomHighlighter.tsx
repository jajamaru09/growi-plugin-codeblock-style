...
export function renderCodeBlock(
  ...
  if (options.showToolbar) {
    ...
    // Filename in toolbar (when both toolbar and filename are set)
    if (options.filename) {
      const filenameLabel = document.createElement('span');
      filenameLabel.className = 'cbs-filename-in-toolbar';
      filenameLabel.textContent = options.filename;
    ...
    // No toolbar — render filename as absolute overlay top-right
    const cite = document.createElement('cite');
    cite.className = 'cbs-filename-label';
    cite.textContent = options.filename;
  ...
  debug('renderCodeBlock', {
    ...
    hasToolbar: options.showToolbar,
    hasFilename: !!options.filename,
    commandLine: options.commandLine,
    diffHighlight: options.diffHighlight,
    highlightLines: highlightSet.size,
    outputLines: outputSet.size,
  });
